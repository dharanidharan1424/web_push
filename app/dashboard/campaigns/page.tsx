        ...
        <div className="space-y-8">
            <div className="flex justify-between items-center">
                <div>
                    ...
                    <p className="text-gray-500 mt-1">Manage and track your push notification campaigns.</p>
                </div>
                <Link
            ...
            <div className="border-b border-gray-200">
                <nav className="-mb-px flex space-x-8">
                    {tabs.map((tab) => (
                        <Link
                            key={tab.id}
                            href={`/dashboard/campaigns?status=${tab.id}`}
                                ...
                                <div className="flex items-center gap-6 mt-4 text-sm">
                                    <div className="flex items-center gap-2 text-gray-600">
                                        <div className="w-6 h-6 rounded-full bg-indigo-50 text-indigo-600 flex items-center justify-center text-xs font-bold">
                                            {notification.website.name.charAt(0)}
                                        </div>
